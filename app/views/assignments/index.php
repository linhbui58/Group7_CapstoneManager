...
.as-topbar h2 { font-size:20px; font-weight:800; color:#0f172a; margin:0 0 4px; }
.as-topbar p  { font-size:13px; color:#64748b; margin:0; }
.as-card { background:#fff; border-radius:20px; box-shadow:0 4px 20px rgba(0,0,0,.06); border:1px solid #f1f5f9; overflow:hidden; }
.as-avatar { width:36px; height:36px; border-radius:10px; display:flex; align-items:center; justify-content:center; font-size:14px; flex-shrink:0; }
#assignmentsTable thead th { font-size:11px; font-weight:700; color:#94a3b8; text-transform:uppercase; letter-spacing:.6px; background:#fafbff; border-bottom:1px solid #f1f5f9 !important; padding:13px 16px; }
#assignmentsTable tbody td { vertical-align:middle; padding:13px 16px; border-color:#f8fafc; font-size:13px; }
#assignmentsTable tbody tr:hover td { background:#f8faff; }
...
<div class="main-content" style="padding:28px 32px; background:#f4f7fe; min-height:100vh;">
    ...
    <div class="as-topbar">
        <div>
            <h2><i class="fa-solid fa-user-check me-2" style="color:#6366f1"></i>Duyệt Đề Tài - Phân Công GV</h2>
            <p>Phân công giảng viên hướng dẫn cho từng đề tài</p>
        </div>
    ...
    <div class="as-card">
        <div class="p-3">
            <table class="table table-hover mb-0" id="assignmentsTable" style="width:100%">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Đề tài</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <div class="as-avatar" style="background:#eff6ff;color:#2563eb">
                                    <i class="fa-solid fa-book-open"></i>
                                </div>
                                <span class="fw-semibold"><?= htmlspecialchars($a['topic_title']) ?></span>
                            </div>
                        </td>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <div class="as-avatar" style="background:#f0fdf4;color:#16a34a">
                                    <i class="fa-solid fa-chalkboard-user"></i>
                                </div>
                                <span><?= htmlspecialchars($a['lecturer_name']) ?></span>
                            </div>
                        </td>
                        <td>
                            <span class="badge" style="background:#f1f5f9;color:#334155;font-size:12px;padding:5px 10px;border-radius:8px">
                                <i class="fa-regular fa-calendar me-1"></i><?= date('d/m/Y', strtotime($a['assigned_at'])) ?>
                            </span>
                        </td>
                        <td class="text-end">
                            <div class="d-flex justify-content-end gap-1">
                                ...
                                <form action="index.php?page=assignment-delete&id=<?= $a['id'] ?>" method="POST"
                                      class="d-inline" onsubmit="return confirm('Xóa phân công này?')">
